...
export function SunRiviera() {
  ...
  return (
    <div className="min-h-screen bg-[#fdf3e9] text-[#3d2817] font-sans selection:bg-[#FF3C00] selection:text-white">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-12 text-center relative z-10">
          {[
            ...
            <div key={i} className="group">
              <div className="font-['Fraunces'] text-5xl md:text-6xl text-[#fffaf2] mb-3 group-hover:scale-105 transition-transform duration-300 font-light italic">{stat.value}</div>
      ...
      <section className="py-32 bg-[#fdf3e9]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="font-['Fraunces'] text-4xl md:text-5xl mb-6 font-medium text-[#3d2817]">Why legacy CRMs fail in Indian Real Estate.</h2>
            <p className="text-lg text-[#3d2817]/70 font-medium">Generic tools weren't built for the scale of site visits, broker networks, and WhatsApp negotiations.</p>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 md:gap-3 relative">
            ...
            {[
              ...
              <div key={i} className="relative z-10 flex-1 group">
                <div className={`border p-5 rounded-2xl shadow-sm group-hover:-translate-y-1 transition-transform duration-300 ${stage.color}`}>
                  <div className="text-xs font-bold tracking-widest mb-3">{stage.name}</div>
                  <div className="text-3xl font-['Fraunces'] opacity-90 italic">{Math.floor(Math.random() * 50 + 10)}</div>
      ...
      <section className="py-32 bg-[#fdf3e9]">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="font-['Fraunces'] text-4xl md:text-5xl text-center mb-24 font-medium text-[#3d2817]">Everything you need to close more deals.</h2>
      ...
      <section className="py-32 bg-[#3d2817] text-[#fffaf2]">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            <p className="text-[#fffaf2]/70 text-lg mb-12 font-medium leading-relaxed">Our proprietary lead rotation engine ensures every inquiry gets a response within minutes, automatically reassigning leads if an agent is unavailable.</p>
      ...
      <section className="py-32 bg-[#fffaf2]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="font-['Fraunces'] text-4xl md:text-5xl mb-6 font-medium text-[#3d2817]">Built for the entire organization</h2>
      ...
      <section className="py-32 bg-[#fffaf2]">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="font-['Fraunces'] text-4xl md:text-5xl text-center mb-20 font-medium text-[#3d2817]">Trusted by top developers</h2>
              ...
              <div key={i} className="bg-[#fdf3e9] p-10 rounded-3xl border border-[#FF3C00]/10 shadow-sm relative group hover:-translate-y-1 transition-transform duration-300">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-[#3d2817]/60 font-medium">{item.role}</div>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="border border-[#FF3C00]/10 bg-[#fdf3e9] rounded-2xl overflow-hidden shadow-sm">
                ...
                {openFaq === i && (
                  <div className="px-8 pb-6 text-[#3d2817]/70 text-[15px] leading-relaxed font-medium">
                    {faq.a}
                  </div>
                )}
              </div>
      ...
      <section className="py-32 bg-[#FF3C00] text-[#fffaf2] text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          ...
          <p className="text-xl md:text-2xl text-[#fffaf2]/80 mb-12 font-medium max-w-2xl mx-auto leading-relaxed">Join top Indian developers managing their pipeline on Leads Rubix.</p>
          <button className="bg-[#3d2817] text-[#fffaf2] px-10 py-5 rounded-full text-lg font-bold hover:bg-[#fffaf2] hover:text-[#3d2817] shadow-xl shadow-amber-900/20 hover:-translate-y-1 transition-all duration-300">
      ...
      {/* 15. Footer */}
      <footer className="bg-[#3d2817] text-[#fffaf2]/60 py-24">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-12 mb-20">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm font-medium leading-relaxed max-w-xs">The intelligent CRM for Indian real estate developers and brokers.</p>
          </div>
          <div>
        ...
        <div className="max-w-7xl mx-auto px-6 text-sm font-medium text-center border-t border-[#fffaf2]/10 pt-10">
