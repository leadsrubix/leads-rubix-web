// ISO 3166-1 alpha-2 country code + ITU-T E.164 calling code list. Sorted with
// India first (default for this market), then alphabetically by name. Keep
// in sync with public lists rather than maintaining bespoke variants.

export interface CountryDialCode {
  code: string; // ISO alpha-2
  name: string;
  dial: string; // leading "+", no spaces
}

const RAW: CountryDialCode[] = [
...
export const COUNTRY_DIAL_CODES: CountryDialCode[] = RAW;
